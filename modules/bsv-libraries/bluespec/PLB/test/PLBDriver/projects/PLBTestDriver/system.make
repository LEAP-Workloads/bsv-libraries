...
# /home/kfleming/bluessdTestRig/src/bsv-libraries/modules/bsv-libraries/bluespec/PLB/test/PLBDriver/projects/PLBTestDriver/system.mhs
# The software specification of the system is in file :
# /home/kfleming/bluessdTestRig/src/bsv-libraries/modules/bsv-libraries/bluespec/PLB/test/PLBDriver/projects/PLBTestDriver/system.mss
...
plb_ppc405_0_libsclean:
	rm -rf plb_ppc405_0/

plb_ppc405_1_libsclean:
	rm -rf plb_ppc405_1/
...
$(PLB_PPC405_0_BOOTLOOP): $(PPC405_BOOTLOOP)
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f $(PPC405_BOOTLOOP) $(PLB_PPC405_0_BOOTLOOP)

$(PLB_PPC405_1_BOOTLOOP): $(PPC405_BOOTLOOP)
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f $(PPC405_BOOTLOOP) $(PLB_PPC405_1_BOOTLOOP)
